  ...
  return (
    <FullScreenModal modal={createRoleModal} onClose={onClose}>
      <FullScreenModalConfirmLayout
        ...
        onConfirm={onCreate}
        title={t(
          `groups.settings.roles.createRoleModal.${
            role.editMode ? 'editTitle' : 'createTitle'
          }`,
        )}>
        <ScrollView>
          {!role.editMode && (
          ...
          <AlertMessage
            level="warning"
            style={comp.input}
            message={t('groups.settings.roles.createRoleModal.alert')}
          />
          <TextField
            style={comp.input}
            value={role?.name}
            ...
            label={t(
              'groups.settings.roles.createRoleModal.roleNameInputLabel',
            )}
          />
          <TextField
            multiline
            ...
            label={t(
              'groups.settings.roles.createRoleModal.roleDescriptionInputLabel',
            )}
          />
          ...
          <SectionList
            ...
            renderItem={({item}) => (
              <RolePermission item={item} onSelect={onSelectScope} />
            )}
            renderSectionHeader={({section: {section}}) => (
              <RoleSectionHeader section={section} />
            )}
          />
        </ScrollView>
      </FullScreenModalConfirmLayout>
