...
export const DrawerNavigator = ({store}) =>
  ...
  >
    <Stack.Screen name="Timers" options={({route}) => drawerOptions({route}, DISABLE_SWIPE.timers)}>
      {props => <TimersStack {...props}/>}
    </Stack.Screen>
    <Stack.Screen name="Groups" options={({route}) => drawerOptions({route}, DISABLE_SWIPE.groups)}>
      {props => <GroupsStack {...props} store={store}/>}
    </Stack.Screen>
    <Stack.Screen name="Premiums" options={({route}) => drawerOptions({route}, DISABLE_SWIPE.premiums)}>
      {props => <PremiumsStack {...props}/>}
    </Stack.Screen>
    <Stack.Screen name="ProfileSettings" options={({route}) => drawerOptions({route}, DISABLE_SWIPE.profile)}>
      {props => <ProfileStack {...props}/>}
    </Stack.Screen>
    <Stack.Screen name="Settings" options={({route}) => drawerOptions({route}, DISABLE_SWIPE.setting)}>
