  ...
  const onDescription = () => {
    ...
    setConfirmModal({
      content: {
        ...
        description: group.description ? group.description : t('groups.timers.noDescription'),
      },
    });
  };
  const onMembers = () => {
  ...
  return (
    <React.Fragment>
      <CustomMenu menu={menu} setMenu={setMenu}>
        ...
        <CustomMenuItem onPress={onHistory} title={t('groups.timers.activityLog')}/>
        <CustomMenuItem onPress={onMembers} title={t('groups.tableHeader.members')}/>
        <CustomMenuItem onPress={onSettings} title={t('components.drawer.settings')}/>
        <CustomMenuItem onPress={onDescription} title={t('groups.settings.common.description')}/>
        <CustomMenuItem onPress={onInviteMember} title={t('groups.settings.members.addMember')}/>
        <CustomMenuItem
          onPress={onComment}
