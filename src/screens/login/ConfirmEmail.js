...
const ConfirmEmail = ({user}) => {
  ...
  return (
    <BackLayout header={false} title={t('confirmEmail.title')}>
      ...
      <CustomText style={[comp.normalText, comp.input]}>{t('confirmEmail.block_2')}</CustomText>
      <CustomButton
        ...
        type={'outline'}
        color={'primary'}
        title={seconds === 0 ? t('confirmEmail.sendEmail') : t('confirmEmail.sendEmailIn', {count: seconds})}
      />
      <TextField
        style={comp.input}
        value={code}
