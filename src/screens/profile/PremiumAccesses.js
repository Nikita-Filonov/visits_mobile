  ...
  return (
    <BackLayout title={t('profile.sidebar.premiumAccesses')}>
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={false} onRefresh={getUserPremium}/>}
      >
        <CustomText style={comp.smallText}>{t('profile.premiumAccesses.description')}</CustomText>
        {load
          ? <Spinner/>
          : <DataGrid
